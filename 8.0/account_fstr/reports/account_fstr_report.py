...
class account_fstr_report(report_sxw.rml_parse, common_report_header):
    ...
    def __init__(self, cr, uid, name, context):
        ...
        self.root_node_obj = self.pool.get('account_fstr.category').browse(cr, uid, category_id, context=context)
        self.category_pool = self.pool.get('account_fstr.category')
