...
class TestAoPurchaseDept(common.SavepointCase):
    ...
    def test_01_dept_passed_on_to_invoice(self):
        """Test department appears correctly in invoice."""
        ...
        self.assertEqual(po_line.invoice_lines.dept, "service")
