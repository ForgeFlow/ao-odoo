...
class lgx_account_aging_hot(models.Model):
    ...
    salesman = fields.Many2one('res.users', string=u'Sales Rep', readonly=True)
    ...
    current = fields.Float(string=u'Total', readonly=True)
